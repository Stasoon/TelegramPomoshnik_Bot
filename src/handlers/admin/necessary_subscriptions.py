...
from src.database.channel import get_channels_full_data, save_channel, delete_channel
...
class Keyboards:
    ...
    def get_channels_markup(cls) -> InlineKeyboardMarkup:
        ...
        for channel_data in get_channels_full_data():
            channels_markup.add(InlineKeyboardButton(
                text=channel_data.get('title'),
...
class Handlers:
    ...
    @classmethod
    def register_subchecking_handlers(cls, dp: Dispatcher):
        ...
        dp.register_message_handler(cls.__handle_message_with_url, is_admin=True,
                                    content_types=['text'],
